...
# Key Decapsulation Using NIST Level 5 algorithms Streamlined NTRU Prime 1277 and SIKE p751 (compressed)
...
client = oqs.KeyEncapsulation(kemalg1, secretkey1)
server1 = oqs.KeyEncapsulation(kemalg1)

shared_secret_client1 = client.decap_secret(ciphertext1)


shared_secret_client2 = x448(secretkey2, ciphertext2)
sharedkeys = (shared_secret_client1+shared_secret_client2)
